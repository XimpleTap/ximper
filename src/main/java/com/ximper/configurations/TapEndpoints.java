...
public class TapEndpoints {
	...
	public static final String TAP_CARD_BALANCE_TOPUP					=	"/tap/{cashierId}/card/{denomId}/reload";
	...
	public static final String TAP_CARD_SALES							=	"/tap/{cashierId}/card/{groupId}/sale";
